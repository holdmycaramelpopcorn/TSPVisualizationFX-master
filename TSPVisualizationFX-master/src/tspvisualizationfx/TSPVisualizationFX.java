...
public class TSPVisualizationFX extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        root.setOnMouseClicked(event -> {
            ...
            root.getChildren().add(circle);
            bestTour = null;
            label.setText("Total City: " + CityManager.getInstance().numberOfCities()+" | Ctrl+Enter: GA, Space: PSO");
        });
        ...
        primaryStage.setTitle("Travelling Salesman Problem - Using both GA and PSO");
